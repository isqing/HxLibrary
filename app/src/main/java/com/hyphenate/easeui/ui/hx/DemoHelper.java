package com.hyphenate.easeui.ui.hx;
...
import com.hyphenate.easeui.ui.hx.db.DemoDBManager;
import com.hyphenate.easeui.ui.hx.db.InviteMessgeDao;
import com.hyphenate.easeui.ui.hx.db.UserDao;
import com.hyphenate.easeui.ui.hx.domain.EmojiconExampleGroupData;
import com.hyphenate.easeui.ui.hx.domain.InviteMessage;
import com.hyphenate.easeui.ui.hx.domain.InviteMessage.InviteMessageStatus;
import com.hyphenate.easeui.ui.hx.domain.RobotUser;
import com.hyphenate.easeui.ui.hx.hxui.ChatActivity;
import com.hyphenate.easeui.ui.hx.hxui.VideoCallActivity;
import com.hyphenate.easeui.ui.hx.hxui.VoiceCallActivity;
import com.hyphenate.easeui.ui.hx.hxutil.HxSPUtils;
import com.hyphenate.easeui.ui.hx.parse.UserProfileManager;
import com.hyphenate.easeui.ui.hx.receiver.CallReceiver;
import com.hyphenate.easeui.ui.hx.util.PreferenceManager;
...
//            return getUserProfileManager().getCurrentUserInfo();
        ...
        if(username.equals(EMClient.getInstance().getCurrentUser())){
            ...
            user.setAvatar((String) HxSPUtils.get(appContext,Constant.EASEPHOTO,""));
            user.setNick((String) HxSPUtils.get(appContext,Constant.EASENICKNAME,""));
            return user;
        }
    	...
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                    ...
                    //接收并处理扩展消息
                    String userName=message.getStringAttribute(Constant.EASENICKNAME,"");
//                    String userId=message.getStringAttribute(Constant.USER_ID,"");
                    String userPic=message.getStringAttribute(Constant.EASEPHOTO,"");
